"""
Custom Select Component — tampilan seperti dropdown wilayah
Ganti native <select> dengan custom dropdown yang styleable

python scripts/custom_select.py
"""
  ...
  (
    {
      ...
      onChange, name, disabled, className, id,
    },
    _ref,
  ) => {
...
Custom Select sekarang:
  ✅ Tampilan konsisten dengan dropdown wilayah
  ✅ Item terpilih highlight emerald + checkmark
  ✅ Dark mode support
  ✅ Keyboard-friendly (focus ring)
  ✅ Compatible dengan react-hook-form {...register()}

npm run dev → cek semua dropdown di form
""")

if __name__ == "__main__":
    print("🔧 Custom Select Component\n")
