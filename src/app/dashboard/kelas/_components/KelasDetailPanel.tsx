        ...
        <div className="space-y-6 pb-6">
          ...
          <div>
            ...
            {loadingStatistik ? (
              ...
              <>
                <div className="mb-4 p-3 rounded-lg bg-gray-50 dark:bg-gray-800/40 space-y-1.5">
                  ...
                  <p className="text-xs text-gray-400 dark:text-gray-500 text-right">
                    Sisa: <span className={statistik.kuotaTersisa <= 0 ? 'text-red-500 dark:text-red-400 font-semibold' : 'text-emerald-600 dark:text-emerald-400 font-semibold'}>{statistik.kuotaTersisa}</span>
                  </p>
                </div>
                <div className="grid grid-cols-2 gap-3">
