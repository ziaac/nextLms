...
export type StatusBiodata   = 'DRAFT' | 'DIAJUKAN' | 'DITERIMA' | 'DITOLAK'
export type StatusSiswaLulus = 'BELUM_DAFTAR' | 'SUDAH_DAFTAR'
export type StatusAnak      = 'KANDUNG' | 'TIRI' | 'ANGKAT'
export type StatusSekolahAsal = 'NEGERI' | 'SWASTA' | 'LUAR_NEGERI'
export type StatusOrtuKandung = 'LENGKAP' | 'CERAI_HIDUP' | 'CERAI_MATI'
export type StatusOrangTua  = 'HIDUP' | 'MENINGGAL'
export type JalurPendaftaran = 'ZONASI' | 'PRESTASI' | 'AFIRMASI' | 'PERPINDAHAN' | 'REGULER'
